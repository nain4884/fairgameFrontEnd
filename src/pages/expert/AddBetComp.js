    ...
    return (
        <>
            ...
            <Box sx={{ background: "#F8C851", marginTop: "20px", borderRadius: "5px", p: "10px", py: "20px", margin: '15px', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                ...
                {!id && <DropDownSimple valued="Select Sports..." dropStyle={{ filter: "invert(.9) sepia(1) saturate(5) hue-rotate(175deg);" }} valueStyle={{ ...imputStyle, color: "white" }} title={'Sports'} data={matchType} valueContainerStyle={{ height: "45px", marginX: "0px", background: "#0B4F26", border: "1px solid #DEDEDE", borderRadius: "5px" }} containerStyle={{ width: "100%", position: 'relative', marginTop: "5px" }} titleStyle={{ marginLeft: "0px", color: '#575757' }} dropDownStyle={{ width: '100%', marginLeft: "0px", marginTop: "0px", position: 'absolute' }} dropDownTextStyle={imputStyle} Detail={Detail} setDetail={setDetail} place={2} />}
                {!id && <DropDownSimple valued="Select Active Match For Betting..." dropStyle={{ filter: "invert(.9) sepia(1) saturate(5) hue-rotate(175deg);" }} valueStyle={{ ...imputStyle, color: "white" }} title={'Available Match For Betting'} data={matches} setMarketId={detailIdSet} matchesSelect={true} valueContainerStyle={{ height: "45px", marginX: "0px", background: "#0B4F26", border: "1px solid #DEDEDE", borderRadius: "5px" }} containerStyle={{ width: "100%", position: 'relative', marginTop: "5px" }} titleStyle={{ marginLeft: "0px", color: '#575757' }} dropDownStyle={{ width: '100%', marginLeft: "0px", marginTop: "0px", position: 'absolute' }} dropDownTextStyle={imputStyle} Detail={Detail} setDetail={setDetail} place={1} />}
            </Box>
            {Detail[3].val === "Session Odds" && <Box sx={{ background: "#F8C851", marginTop: "20px", borderRadius: "5px", p: "10px", py: "20px", margin: '15px', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                ...
                <Box sx={{ display: "flex", marginTop: "30px" }}>
                    ...
                    <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Rate Percent"} type={"text"} value="Enter Name of Team B..." InputValType={"InputVal"} place={12} DetailError={{ Error, setDetail, Detail, setError, type: "Number" }} />
                </Box>
                <Box sx={{ display: "flex", marginTop: "20px" }}>
                    <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Yes Rate"} type={"text"} value="Enter Name of Team A..." InputValType={"InputVal"} place={11} DetailError={{ Error, setDetail, Detail, setError, type: "Number" }} />
                    <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"No Rate"} type={"text"} value="Enter Name of Team B..." InputValType={"InputVal"} place={10} DetailError={{ Error, setDetail, Detail, setError, type: "Number" }} />
                </Box>
            </Box>}
            {Detail[3].val === "Match Odds" && <Box sx={{ background: "#F8C851", marginTop: "20px", borderRadius: "5px", p: "10px", py: "20px", margin: '15px', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                <Typography sx={{ fontSize: "18px", fontWeight: "600", color: '#000000' }}>Match Bet</Typography>
                <Box sx={{ display: "flex", marginTop: "30px" }}>
                    <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Team A Back"} type={"text"} value="Enter Name of Team A..." InputValType={"InputVal"} place={6} DetailError={{ Error, setDetail, Detail, setError, type: "Number" }} />
                    <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Team A Lay"} type={"text"} value="Enter Name of Team B..." InputValType={"InputVal"} place={4} DetailError={{ Error, setDetail, Detail, setError, type: "Number" }} />
                    <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Draw Rate"} type={"text"} value="Enter Name of Team A..." InputValType={"InputVal"} place={8} DetailError={{ Error, setDetail, Detail, setError, type: "Number" }} />
                </Box>
                <Box sx={{ display: "flex", marginTop: "20px" }}>
            ...
            {thisMatchDetail && <Box sx={{ background: "#F8C851", marginTop: "20px", borderRadius: "5px", p: "10px", py: "20px", margin: '15px', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                <Typography sx={{ fontSize: "18px", fontWeight: "600", color: '#000000' }}>Match Detail</Typography>
                <Box sx={{ display: "flex", marginTop: "30px" }}>
                    <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Session Bet"} titleSize={'20px'} type={"text"} value="Enter Name of Team A..." />
                    <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Team A Lay"} type={"text"} value="Enter Name of Team B..." InputValType={"InputVal"} place={4} DetailError={{ Error, setDetail, Detail, setError, type: "Number" }} />
                    <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Draw Rate"} type={"text"} value="Enter Name of Team A..." InputValType={"InputVal"} place={8} DetailError={{ Error, setDetail, Detail, setError, type: "Number" }} />
                </Box>
                <Box sx={{ display: "flex", marginTop: "20px" }}>
            ...
            {showSuccessModal && <Modal message={showModalMessage} setShowSuccessModal={handleChangeShowModalSuccess} showSuccessModal={showSuccessModal} buttonMessage={'OK'} navigateTo={'match'} />}
        </>
    )
}

const LabelValueComponent = ({ title, containerStyle, titleSize, headColor, InputValType, DetailError, place }) => {
    return (
        <Box className="beFairMatch" sx={[containerStyle]}>
            ...
            {InputValType ? <input sx={{ borderRadius: '5px' }} type={DetailError?.type} onChange={(e) => {
                console.log('DetailError?.type === "Number"', DetailError?.type === "Number")
                DetailError.setDetail({
                    ...DetailError.Detail, [place]: {
                        ...DetailError.Detail[place],
                        val: DetailError?.type === "Number" ? parseInt(e.target.value) : e.target.value.toString()
                    }
                });
