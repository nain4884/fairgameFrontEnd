    ...
    return (
        <Background>
            ...
            <Box sx={{ background: "white", borderRadius: "5px", m: "10px", p: "10px" }}>
                ...
                <Box sx={{ margin: '15px' }}>
                    <LabelValueComponent title={'Add Match'} notShowSub={true} titleSize={'20px'} headColor={'#000000'} />
                </Box>
                <Box sx={{ background: "#F8C851", marginTop: "20px", borderRadius: "5px", p: "10px", py: "20px" }}>
                    <Box sx={{ display: "flex" }}>
                        ...
                        <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Team A"} type={"text"} value="Enter Name of Team A..." place={9} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
                        <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Team B"} type={"text"} value="Enter Name of Team B..." place={13} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
                        <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Team C"} type={"text"} value="Enter Name of Team C..." place={17} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
                    </Box>
                    <Box sx={{ display: "flex", marginTop: "20px" }}>
                        ...
                        <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Betfair Match Min Bet"} type={"Number"} value="Enter your Match Min Bet..." place={18} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
                    ...
                    <Box sx={{ display: "flex", marginTop: "20px" }}>
                        <LabelValueComponent valueStyle={{}} containerStyle={{ flex: 1 }} title={"Betfair Match Max Bet"} type={"Number"} value="Enter your Match Max Bet..." place={3} DetailError={{ Error, setDetail, Detail, setError, type: "Number" }} />
                        <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Betfair Session Min Bet"} type={"Number"} value="Betfair Session Min Bet..." place={7} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
                        <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Betfair Session Max Bet"} type={"Number"} value="Betfair Session Max Bet..." place={11} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
                        <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Betfair Bookmaker Max Bet"} type={"Number"} value="Enter  Bookmaker Max Bet..." place={15} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
                        <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Betfair Bookmaker Min Bet"} type={"Number"} value="Enter Bookmaker Min Bet..." place={12} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
                    </Box>
                    <Box sx={{ display: "flex", marginTop: "20px" }}>
                        <LabelValueComponent valueStyle={{}} containerStyle={{ flex: 1 }} title={"Bookmaker Manual Max Bet"} type={"Number"} value="Enter Bookmaker Manaul Max Bet..." place={4} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
                        <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Bookmaker Manual Min Bet"} type={"Number"} value="Enter Bookmaker Manaul Max Bet..." place={8} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
                        <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Manaual Session Min Bet"} type={"Number"} value="Enter Session Min Bet..." place={16} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
                        <LabelValueComponent containerStyle={{ flex: 1, marginLeft: "1%" }} title={"Manaual Session Max Bet"} type={"Number"} value="Enter Session Max Bet..." place={19} DetailError={{ Error, setDetail, Detail, setError, type: "String" }} />
...
const LabelValueComponent = ({ title, value, icon, containerStyle, valueStyle, valueContainerStyle, InputValType, place, DetailError, type, notShowSub, titleSize, headColor }) => {
    return (
