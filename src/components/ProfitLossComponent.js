        ...
        return (
            <Box
                ...
                <Box sx={{ width: { mobile: '40%', laptop: "60%" }, height: '100%', alignItems: 'center', display: 'flex', paddingX: '10px', background: '#F8C851', marginLeft: .1, justifyContent: 'space-between' }}>
                    <Typography sx={{ fontSize: '15px', color: 'black', fontWeight: '600' }} >{"Cricket"}</Typography>
    ...
    const RowComponent = ({ index }) => {
        ...
        return (
            <Box sx={{ width: '100%' }}>
                <Box onClick={() => {
                    setShow(!show)
                }} sx={{ width: '100%', height: '40px', background: 'white', display: 'flex', padding: .1 }}>
                    ...
                    <Box sx={{ width: { mobile: '40%', laptop: "60%" }, position: 'relative', height: '100%', paddingY: '4px', alignItems: { laptop: 'center', mobile: "flex-end" }, display: 'flex', paddingX: '10px', background: '#0B4F26', marginLeft: .1, justifyContent: 'space-between' }}>
                        ...
                        <Box sx={{ flexDirection: 'row', display: 'flex', alignItems: 'center' }} >
                            <Typography sx={{ fontSize: { mobile: '10px', laptop: '15px' }, color: 'white', fontWeight: '600' }} >{"INDIA VS PAKISTAN "}</Typography>
                            <Typography sx={{ fontSize: { laptop: '10px', mobile: '0' }, color: 'white', marginLeft: '5px', fontWeight: '500' }}>(04-11-2022)</Typography>
                        </Box>
                ...
                {show && <Box sx={{ width: { mobile: '100%', laptop: '96%' }, marginTop: { mobile: '.25vh' }, marginLeft: { laptop: '4%' }, display: 'flex', flexDirection: { laptop: 'row', mobile: "column" } }}>
                    <SessionBetSeperate profit />
                    <Box sx={{ width: { laptop: '1vw', mobile: 0 } }} ></Box>
                    <AllRateSeperate profit />
                </Box>}
            </Box>
        )
    }
