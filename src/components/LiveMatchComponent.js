...
const LiveMatchComponent = ({ }) => {
    ...
    return (
        <Box sx={[{ position: 'relative', width: { tablet: "55%", mobile: "100%", laptop: '100%' }, display: 'flex', flexDirection: 'column', alignSelf: 'center', marginX: { laptop: '0vw', mobile: '0px', tablet: '0px' }, marginTop: ".5vh", borderRadius: '2px', background: 'white', alignSelf: { mobile: 'center', tablet: 'center', laptop: "flex-start" } }]}>
