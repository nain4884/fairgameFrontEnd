...
import { ARROWUP } from "../admin/assets/index"
import './index.css'

const LiveMatchComponent = () => {
    const [visible, setVisible] = useState(true)
    return (
        <Box sx={[{ position: 'relative', width: { tablet: "55%", mobile: "100%", laptop: '100%' }, display: 'flex', flexDirection: 'column', marginX: { laptop: '0vw', mobile: '0px', tablet: '0px' }, marginTop: ".5vh", borderRadius: '2px', background: 'white', alignSelf: { mobile: 'center', tablet: 'center', laptop: "flex-start" } }]}>
            ...
            {visible && <Box sx={{ display: 'flex', padding: '1vh', flexDirection: 'column', flex: 1, justifyContent: 'flex-end', borderBottom: '0px solid', borderColor: 'gray' }} >
                ...
                <Box sx={{ display: 'flex' }} >
                    ...
                    <Box sx={{ flex: .2, alignItems: 'center', flexDirection: 'column', display: 'flex', marginTop: '1vh' }} >
