...
const DropDownSimple = ({ valued, title, data, containerStyle, titleStyle, valueContainerStyle, valueStyle, dropStyle, dropDownStyle, dropDownTextStyle, Detail, setDetail, place, setMarketId, matchesSelect }) => {
