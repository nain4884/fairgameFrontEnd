    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', alignSelf: 'center', justifyContent: 'center', alignItems: 'center', paddingBottom: '1vh' }}>
            ...
            <Box sx={{ display: 'flex', borderRadius: '5px', width: '99%', px: "10px", minHeight: "80px", background: '#F8C851' }}>
                <Calendar pickerStyles={{ height: "40px" }} containerStyle={{ width: matchesMobile ? "31%" : "19%", height: "40px" }} title={'From'} />
                <Calendar pickerStyles={{ height: "40px" }} containerStyle={{ width: matchesMobile ? "31%" : "19%", marginLeft: "20px", height: "40px" }} title={'To'} />
                {/* <CalendarImage pickerStyles={{ height: "40px" }}  containerStyle={{ width: matchesMobile ? "31%" : "19%", marginLeft: "10px", height: "40px" }} title={'To'} /> */}
                <CustomButton btnStyle={{ height: "40px", borderRadius: "5px", width: matchesMobile ? "32%" : "20%", marginRight: "0px", marginLeft: matchesMobile ? "10px" : "20px", marginBottom: matchesMobile ? "15px" : (tab ? "28px" : "15px") }} />
            </Box>
        </Box>
    )
}
