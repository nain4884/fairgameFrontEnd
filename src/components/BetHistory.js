...
const BetHistory = ({ profit, mark, setPageCountOuter, mark2, allBetsData, count, callPage, betData }) => {
        ...
        <>
            {
                ...
                >
                    ...
                    >
                        ...
                        {[...new Set(betData?.filter((v) => v.sessionBet !== true))]?.map((i, k) => {
                            {/* {betData?.map((i, k) => { */ }
                            const num = k + 1;
        ...
        >
            {!header && (
                <>
                    ...
                    <SingleBox color={getColor()} data={data?.amount} header={header} width={"50%"} />
                </>
            )}
            {header && (
                <>
