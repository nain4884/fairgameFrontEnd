...
const Divider = () => {
  return (
    <Box
      sx={{ width: "100%", background: "rgba(211,211,211)", height: "1px" }}
    ></Box>
  );
};
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Maximum Bet {data?.betfair_match_max_bet}
          </Typography>
          <img
            src={Info}
            style={{
...
const MatchOdds = ({ data }) => {
  console.log(
    "data.apiSessionActive, data.matchSessionData.length",
    data.apiSessionActive,
    data.matchSessionData.length
  );
  return (
