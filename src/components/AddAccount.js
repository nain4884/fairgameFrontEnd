...
const AddAccount = () => {
    ...
    return (
        <>
            ...
            {showSuccessModal && <Modal message={successShow} setShowSuccessModal={handleChangeShowModalSuccess} showSuccessModal={showSuccessModal} buttonMessage={'OK'} navigateTo={'list_of_clients'} />}
        </>
    )
}
