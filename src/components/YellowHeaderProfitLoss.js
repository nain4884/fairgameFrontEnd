    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', alignSelf: 'center', justifyContent: 'center', alignItems: 'center', paddingBottom: '.1vh' }}>
            ...
            <Box sx={{ display: 'flex', borderRadius: '5px', flexDirection: 'column', width: '99%', paddingY: { laptop: '0vh', mobile: '1vh' }, background: '#F8C851', alignSelf: 'center', justifyContent: 'space-evenly' }}>
                <Box sx={{ display: 'flex', width: {laptop: '60%', mobile: '100%'}, flexDirection: { laptop: "row", mobile: "column" }, padding: "10px 20px" }}>
                    <Box sx={{ display: "block", width: { mobile: "100%", laptop: "40%" } }} >
                        <Box sx={{ width: '10px' }} ></Box>
                        <SearchInputWallet containerStyle={{width: "100% !important "}} data={clientData} title={'Search By Client Name'} setSearch={setSearch} search={search} />
                        
                    </Box>

                        <Box sx={{ width: '10px' }} ></Box>

                    <Box sx={{ display: "flex", width: { mobile: "100%", laptop: "60%" } }} >
                        <Box sx={{ display: "flex", width: {laptop:  "70%", mobile: "60%"} }} >
                        ...
                        <Box sx={{ width: '10px' }} ></Box>
                        <Box sx={{ width: {mobile: "40%", laptop: "30%"}, alignSelf: "flex-end" }} >
                        <Typography sx={{ fontSize: '12px', fontWeight: '600', marginBottom: '.3vh', opacity: "0",  }}>456</Typography>
                            <CustomButtonAdmin
                                onClick={onClick}
                                btnStyle={{
