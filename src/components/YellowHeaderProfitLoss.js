...
const YellowHeaderProfitLoss = () => {
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', alignSelf: 'center', justifyContent: 'center', alignItems: 'center', paddingBottom: '.1vh' }}>
            ...
            <Box sx={{ display: 'flex', borderRadius: '5px', flexDirection: 'column', width: '99%', paddingY: {laptop: '3vh', mobile: '1vh'}, background: '#F8C851', alignSelf: 'center', justifyContent: 'space-evenly' }}>
